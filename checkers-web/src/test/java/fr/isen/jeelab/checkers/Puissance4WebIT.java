package fr.isen.jeelab.checkers;

import static org.assertj.core.api.Assertions.assertThat;
import static fr.isen.jeelab.checkers.core.ChipColour.BLACK;
import static fr.isen.jeelab.checkers.core.ChipColour.WHITE;
...
public class Puissance4WebIT {
    ...
    public void aPlayerMayPlayAColumn() throws Exception {
        page.play(3);
        assertThat(page.getCell(3,0)).isEqualTo(BLACK);

        page.play(3);
        assertThat(page.getCell(3,1)).isEqualTo(WHITE);
    ...
    public void aPlayerMayWin() throws Exception {
        ...
        assertThat(page.getWinner()).isEqualTo(BLACK);
    }
